...
const dict: Translations = {
  ...
  'controls.rotateFree': 'Kulma asteina',
  ...
  'apps.portable': 'Siirrettävä',
  'apps.source': 'Lähdekoodi',
  'apps.zipSub': 'ZIP-arkisto',
  'apps.dockerSub': 'Kopioi komento',
  'apps.unraidSub': 'Malli',
