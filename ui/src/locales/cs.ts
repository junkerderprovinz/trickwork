...
const dict: Translations = {
  ...
  'controls.rotateFree': 'Úhel ve stupních',
  ...
  'apps.portable': 'Přenosná',
  'apps.source': 'Zdrojový kód',
  'apps.zipSub': 'Archiv ZIP',
  'apps.dockerSub': 'Kopírovat příkaz',
  'apps.unraidSub': 'Šablona',
