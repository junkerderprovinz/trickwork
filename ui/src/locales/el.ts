...
const dict: Translations = {
  ...
  'controls.rotateFree': 'Γωνία σε μοίρες',
  ...
  'apps.portable': 'Φορητό',
  'apps.source': 'Πηγαίος κώδικας',
  'apps.zipSub': 'Αρχείο ZIP',
  'apps.dockerSub': 'Αντιγραφή εντολής',
  'apps.unraidSub': 'Πρότυπο',
