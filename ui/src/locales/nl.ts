...
const dict: Translations = {
  ...
  'controls.rotateFree': 'Hoek in graden',
  ...
  'apps.portable': 'Draagbaar',
  'apps.source': 'Broncode',
  'apps.zipSub': 'ZIP-archief',
  'apps.dockerSub': 'Opdracht kopiëren',
  'apps.unraidSub': 'Sjabloon',
