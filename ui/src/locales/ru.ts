...
const dict: Translations = {
  ...
  'controls.rotateFree': 'Угол в градусах',
  ...
  'apps.portable': 'Портативная',
  'apps.source': 'Исходный код',
  'apps.zipSub': 'Архив ZIP',
  'apps.dockerSub': 'Скопировать команду',
  ...
  'about.title': 'О программе TrickWork',
  ...
  'about.coffee': 'Если TrickWork заслужил место на твоём сервере или компьютере, брось монету своему рыцарю: она помогает покрыть расходы и держит проект живым. И сердце этого рыцаря бьётся немного быстрее. Ниже три пути, выбери тот, что тебе подходит.',
