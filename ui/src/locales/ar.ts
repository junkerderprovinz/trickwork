...
const dict: Translations = {
  ...
  'controls.rotateFree': 'الزاوية بالدرجات',
  ...
  'apps.portable': 'محمول',
  'apps.source': 'الشيفرة المصدرية',
  'apps.zipSub': 'أرشيف ZIP',
  'apps.dockerSub': 'نسخ الأمر',
  'apps.unraidSub': 'قالب',
  ...
  'about.coffee': 'إذا استحق TrickWork مكانًا على خادمك أو حاسوبك، فألقِ عملة لفارسك: تساعد في تغطية التكاليف وتبقي المشروع حيًا. كما تجعل قلب هذا الفارس ينبض أسرع قليلًا. في الأسفل ثلاث طرق، اختر ما يناسبك.',
