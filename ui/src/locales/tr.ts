...
const dict: Translations = {
  ...
  'controls.rotateFree': 'Derece cinsinden açı',
  ...
  'apps.portable': 'Taşınabilir',
  'apps.source': 'Kaynak kod',
  'apps.zipSub': 'ZIP arşivi',
  'apps.dockerSub': 'Komutu kopyala',
  'apps.unraidSub': 'Şablon',
