...
const dict: Translations = {
  ...
  'apps.dockerSub': 'Kopiér kommando',
  'apps.unraidSub': 'Skabelon',
  ...
  'about.coffee': 'Hvis TrickWork har fortjent en plads på din server eller computer, så kast en mønt til din ridder: det hjælper med at dække omkostningerne og holder projektet i live. Og det får denne ridders hjerte til at slå lidt hurtigere. Nedenfor er der tre veje, tag den, der passer dig.',
