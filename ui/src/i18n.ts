...
export const en = {
  ...
  'controls.rotateFree': 'Angle in degrees',
  ...
  'apps.zipSub': 'ZIP archive',
  'apps.dockerSub': 'Copy command',
  'apps.unraidSub': 'Template',
...
export const de: Translations = {
  ...
  'controls.rotate180': '180°',
  'controls.rotate270': '270°',
  'controls.rotateFree': 'Winkel in Grad',
  ...
  'apps.source': 'Quellcode',
  'apps.zipSub': 'ZIP-Archiv',
  'apps.dockerSub': 'Befehl kopieren',
  'apps.unraidSub': 'Vorlage',
